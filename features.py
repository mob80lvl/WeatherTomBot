    ...
    if low.startswith("/apikey"):
        if low == "/apikey":
            ...
            if not key:
                ...
                _send(uid, _FT(uid, "api_created", key=key))
        else:
