...
TEXTS = {'ru': {'welcome': '🌤 *Добро пожаловать в МетеоБот!*\n'
 ...
 'zh': {'welcome': '🌤 *欢迎来到天气机器人！*\n\n🏙️ *开始使用前，请指定您的城市。*\n\n在回复中发送城市名称。',
    ...
    'fr': {
        ...
        'btn_tomorrow': '📅 Demain',
        'btn_ai': '🤖 Assistant IA',
        'btn_favorites': '⭐ Villes',
        'btn_autopost': '📢 Auto-publication',
        'btn_card': '🖼 Carte météo',
        'btn_api': '🔑 API',
        'btn_team': '👥 Équipe',
        'btn_whitelabel': '🏷 White-label',
        'btn_analytics': '📊 Analytique',
        'btn_add_city': '➕ Ajouter une ville',
        'btn_remove_city': '➖ Supprimer une ville',
        'btn_wl_name': '✏️ Nom',
        'btn_wl_color': '🎨 Couleur',
        'btn_wl_logo': '🖼 Logo'
    },
    'de': {
        ...
        'btn_tomorrow': '📅 Morgen',
        'btn_ai': '🤖 KI-Assistent',
        'btn_favorites': '⭐ Städte',
        'btn_autopost': '📢 Auto-Posting',
        'btn_card': '🖼 Wetterkarte',
        'btn_api': '🔑 API',
        'btn_team': '👥 Team',
        'btn_whitelabel': '🏷 White-Label',
        'btn_analytics': '📊 Analytik',
        'btn_add_city': '➕ Stadt hinzufügen',
        'btn_remove_city': '➖ Stadt entfernen',
        'btn_wl_name': '✏️ Name',
        'btn_wl_color': '🎨 Farbe',
        'btn_wl_logo': '🖼 Logo'
    },
    'ja': {
        ...
        'btn_api': '🔑 API',
        'btn_team': '👥 チーム',
        'btn_whitelabel': '🏷 ホワイトラベル',
        'btn_analytics': '📊 アナリティクス',
        'btn_add_city': '➕ 都市を追加',
        'btn_remove_city': '➖ 都市を削除',
        'btn_wl_name': '✏️ 名前',
        'btn_wl_color': '🎨 色',
        'btn_wl_logo': '🖼 ロゴ'
    },
    'ko': {
        ...
        'btn_api': '🔑 API',
        'btn_team': '👥 팀',
        'btn_whitelabel': '🏷 화이트라벨',
        'btn_analytics': '📊 분석',
        'btn_add_city': '➕ 도시 추가',
        'btn_remove_city': '➖ 도시 삭제',
        'btn_wl_name': '✏️ 이름',
        'btn_wl_color': '🎨 색상',
        'btn_wl_logo': '🖼 로고'
    },
    'it': {
        ...
        'btn_trip': '✈️ Viaggio',
        'btn_tomorrow': '📅 Domani',
        'btn_ai': '🤖 Assistente IA',
        'btn_favorites': '⭐ Città',
        'btn_autopost': '📢 Auto-pubblicazione',
        'btn_card': '🖼 Carta meteo',
        'btn_api': '🔑 API',
        'btn_team': '👥 Team',
        'btn_whitelabel': '🏷 White-label',
        'btn_analytics': '📊 Analitica',
        'btn_add_city': '➕ Aggiungi città',
        'btn_remove_city': '➖ Rimuovi città',
        'btn_wl_name': '✏️ Nome',
        'btn_wl_color': '🎨 Colore',
        'btn_wl_logo': '🖼 Logo'
    },
    'hi': {
        ...
        'btn_ai': '🤖 AI सहायक',
        'btn_favorites': '⭐ शहर',
        'btn_autopost': '📢 स्वचालित पोस्टिंग',
        'btn_card': '🖼 मौसम कार्ड',
        'btn_api': '🔑 API',
        'btn_team': '👥 टीम',
        'btn_whitelabel': '🏷 व्हाइट-लेबल',
        'btn_analytics': '📊 विश्लेषण',
        'btn_add_city': '➕ शहर जोड़ें',
        'btn_remove_city': '➖ शहर हटाएं',
        'btn_wl_name': '✏️ नाम',
        'btn_wl_color': '🎨 रंग',
        'btn_wl_logo': '🖼 लोगो'
    },
    'ar': {
        ...
        'btn_ai': '🤖 مساعد AI',
        'btn_favorites': '⭐ مدن',
        'btn_autopost': '📢 نشر تلقائي',
        'btn_card': '🖼 بطاقة الطقس',
        'btn_api': '🔑 API',
        'btn_team': '👥 فريق',
        'btn_whitelabel': '🏷 علامة بيضاء',
        'btn_analytics': '📊 تحليلات',
        'btn_add_city': '➕ إضافة مدينة',
        'btn_remove_city': '➖ إزالة مدينة',
        'btn_wl_name': '✏️ الاسم',
        'btn_wl_color': '🎨 اللون',
        'btn_wl_logo': '🖼 الشعار'
    }
...
"""
        ...
        elif text in ["🇷🇺 Русский", "🇬🇧 English", "🇪🇸 Español", "🇨🇳 中文", "🇫🇷 Français", "🇩🇪 Deutsch", "🇯🇵 日本語", "🇰🇷 한국어", "🇮🇹 Italiano", "🇮🇳 हिन्दी", "🇸🇦 العربية"]:
            lang_map = {
                "🇷🇺 Русский": "ru",
                "🇬🇧 English": "en",
                "🇪🇸 Español": "es",
...
def admin_texts():
    ...
    for lang_code, lang_name in [("ru", "🇷🇺 Русский"), ("en", "🇬🇧 English"), ("es", "🇪🇸 Español"), ("zh", "🇨🇳 中文"), ("fr", "🇫🇷 Français"), ("de", "🇩🇪 Deutsch"), ("ja", "🇯🇵 日本語"), ("ko", "🇰🇷 한국어"), ("it", "🇮🇹 Italiano"), ("hi", "🇮🇳 हिन्दी"), ("ar", "🇸🇦 العربية")]:
